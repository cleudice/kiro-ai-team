---
name: retrospective
description: Converte falha recorrente em UMA regra objetiva em steering/retro-learnings.md (cap ~30 regras ativas); se valer para todos os projetos, vira PR no ai-team central. Use quando a mesma falha ocorrer pela 2ª vez ou pedirem 'retro', 'vire regra', 'como evitar de novo'.
---
# retrospective
## Gatilhos
...
4. Regra vale para todos os projetos? → abrir issue/PR no repo ai-team (guidelines ou skill correspondente) em vez de duplicar por projeto.
## Regras
