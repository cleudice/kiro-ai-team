...
6. Após o merge efetivo: atualizar `status: merged` no brief `docs/issues/<ID>.md`, `check-gates.sh bump-counter` (agenda audit-integration a cada 5) e acionar resolve-issue.
